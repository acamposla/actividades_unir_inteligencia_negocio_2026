...
## Detección de ceros sospechosos (TRAMPA de examen)
...
# Ejemplo diabetes: ceros que son nulos disfrazados
...
# Eliminar filas por condición (ceros sospechosos)
datos <- datos[datos$Glucose != 0, ]              # Una columna
datos <- datos[datos$Glucose != 0 & datos$BMI != 0, ]  # Varias columnas
```
...
# ELIMINAR: quiero quitar filas donde Glucose sea 0 o BMI sea 0
datos %>% filter(Glucose != 0 & BMI != 0)     # & porque AMBAS deben cumplirse
